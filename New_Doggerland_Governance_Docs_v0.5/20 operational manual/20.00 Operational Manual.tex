...
\title{New Doggerland - Operational Manual v0.5}
\author{}
\date{}
\begin{document}
\maketitle
...
New Doggerland - Operational Manual v0.5
...
\item {Expiration of the review clock without documented closure requires automatic human review by the Classification Panel or its delegate.}
\item {No emergency action may bypass quorum, term-validity, or classification safeguards required by the Constitution.}
\end{itemize}
